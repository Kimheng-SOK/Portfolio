...
const typeIcons: { [key: string]: typeof Trophy } = {
  milestone: Trophy,
  skill: BookOpen,
  project: Briefcase,
...
const Journey = () => {
  ...
  const completedMilestones = journeyData.filter(
    (item) => item.type === "milestone" || parseInt(item.year) < 2026,
  ).length;
      ...
      <div className="container">
        ...
        >
          ...
          <p className="section-subtitle">
            A timeline of my growth, learning milestones, and key
        ...
        <div className="journey-timeline" ref={timelineRef}>
          ...
          {journeyData.map((item, index) => {
            ...
            const isCompleted =
              item.type === "milestone" || parseInt(item.year) <= 2025;
