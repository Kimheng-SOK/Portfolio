      ...
      <div className="container">
        ...
        >
          ...
          <motion.div className="about-intro" variants={itemVariants}>
            ...
            <p>
              I'm a passionate Full Stack Developer and UI/UX Designer creating
            ...
            <p>
              ...
              user-centered development. Whether it's building scalable web
              applications, mobile apps, or leveraging no-code automation tools
              like GoHighLevel for business workflows — every project is an
            ...
            >
              ...
              <p>
                Our team was recognized and selected as Startup Founders for{" "}
                <strong>Digistall</strong> — a comprehensive leasehold
                management system now deployed and serving real users.
              </p>
            </motion.div>
          </motion.div>
